...
/*
    ...
    nextstep.corner = 12;
    nextstep.color = colors[0];
    nextstep.highlightColor = colors[1];
    nextstep.pressColor = colors[2];
    nextstep.labelMinExtent = new Point(36, 18);
    nextstep.padding = 0;
    nextstep.labelShadowOffset = new Point(-1, -1);
    nextstep.labelShadowColor = colors[1];
    nextstep.labelColor = this.buttonLabelColor;
    nextstep.contrast = this.buttonContrast;
    nextstep.drawNew();
    nextstep.hint = "Next";
    db.add(nextstep);
*/
